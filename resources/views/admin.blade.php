...
<center><h1 style="  margin-bottom: 20px;
        font-size: 55px;
        color: red;">Match Schedule<span style="  font-size: 20px;"><a href="{{route('addschedule')}}">+Add schedule</a></span></h1></center>
...
<td style=" padding: 10px;
        border-bottom: 1px solid #aaa;"><a href="{{route('deleteschedule',['id'=>$schedule->id])}}">Delete</a></td>
